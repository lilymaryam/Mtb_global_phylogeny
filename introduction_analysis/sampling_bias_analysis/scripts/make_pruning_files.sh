...
# Check if we're in the sampling_bias_analysis directory
...
for country in "${countries[@]}"; do
    for downsample in "${downsamples[@]}"; do
        ...
        output_file="data/prune_samples_${country}_${pct}pct.tsv"
...
for downsample in "${downsamples[@]}"; do
    ...
    output_file="data/prune_samples_ALL_${pct}pct.tsv"
